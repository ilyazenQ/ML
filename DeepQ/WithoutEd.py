...
''' enviroment'''
n_f = 1                                            
random_consumption_on = True       

act = ['up_power1', 'down_power1', 'up_power2', 'down_power2', 'no actions']                             
...
class Sys(tk.Tk, object):
    ...
    def _build_system(self):
        ...
        self.freq_text = self.canvas.create_text(350, 200, text = str('Потребитель'),fill="black")
...
def run_env():
    ...
    for episode in range(1):   # 
        ...
        fig, ax = plt.subplots()
        ax.plot(y, color = "red", label="Модель без обучения")
        ax.set_xlabel("шаг")
        ax.set_ylabel("частота, Гц")
        ax.legend()
        fig.savefig('./WithoutEd.png')
